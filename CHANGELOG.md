...
* switch on autoConvert for all icons including animated gifs, now these can be autoconverted ([3e0c8e3](https://github.com/yotoplay/twine-to-yoto/commit/3e0c8e3d120ecd62f14648c2ebdf7c18760b87a1))
